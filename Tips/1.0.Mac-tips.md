...
```
➜  ~ ls -a
.                                .flutter                         .vscode                          Movies
..                               .gitconfig                       .wns                             Music
.android                         .oh-my-zsh                       .zshrc 
...
export PATH="$PATH:/Users/jiemao/development/flutter/bin"
export PATH="/Users/jiemao/mongodb-5.0.0/bin:$PATH"
```
打开新的tab 就可以执行命令了
...
➜  ~ brew -v
Homebrew 3.1.1
Homebrew/homebrew-core (git revision 13c338a6e4; last commit 2021-04-13)

➜  homebrew git:(stable) brew --help
Example usage:
...
### 触控板相关
1. 触控板所有手势全部打开
2. 轻点拖动需要在 辅助功能 - 鼠标与触控板 - 触控板选项 -  启用拖移(不使用拖移锁定)