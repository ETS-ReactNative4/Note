...
function getCookie2(t) {
    for (var e = t + "=", i = e.length, s = document.cookie.length, n = 0; n < s; ) {
        var a = n + i;
        if (document.cookie.substring(n, a) == e)
            return getCookie1(a);
        if (n = document.cookie.indexOf(" ", n) + 1,
        0 == n)
            break
    }
    return null
...
function generateBezier(t, e, i, s) {
    ...
    function f(e) {
        for (var s = 0, n = 1, a = m - 1; n != a && b[n] <= e; ++n)
            s += O;
        --n;
...
function wheel(t) {
    if (!sogou.manager.locked) {
        ...
        e < 0 ? (sogou.manager.auto = !1,
        sogou.manager.next(!1, sogou.manager.globalT, function() {
            pingApp.getDlBtnClick("wheeldown", {
                idx: i
            })
        })) : e > 0 && (sogou.manager.auto = !1,
        sogou.manager.reverse(!1, sogou.manager.globalT, function() {
...
var PingbackApp = function() {
    ...
    this.getUid = function() {
        var t = "";
        return null != getCookie2("SMYUV") ? t = getCookie2("SMYUV") : (t = i,
        setCookie("SMYUV", t, 2592e6, "sogou.com")),
        t
    }
    ,
    ...
    this.getClick = function(e) {
        ...
        try {
            for (; "A" == i.tagName.toUpperCase() || "INPUT" == i.tagName.toUpperCase() || "IMG" == i.tagName.toUpperCase(); ) {
                is_link = !1,
                ...
                if (a = encodeURIComponent(a),
                clickFrom = window.location.href,
                "" == s || "" == address)
                    break;
                for (var r = (new Date).getTime(), o = escape(1e3 * r + Math.round(1e3 * Math.random())), h = i.parentNode; !h.id; )
                    h = h.parentNode;
                mod = h.id;
    ...
    t.notify = t.prototype.notify = function(t) {
        ...
        if (e && "string" == typeof t)
            for (var i = 0; i < e.length; ++i) {
                var s = e[i];
                "function" == typeof s ? s.apply(null, [].slice.call(arguments, 1)) : (e.splice(i, 1),
                --i)
            }
    }
    ,
...
function(t, e) {
    ...
    function s(t, e, s) {
        ...
        e = [],
        s = !0; h[++a]; )
            "boolean" === i(h[a]) ? s = h[a] : "object" === i(h[a]) && e.push(h[a]);
        for (e.length >= 2 && (t = e.splice(0, 1)[0]),
        a = 0; a < e.length; a++) {
            h = e[a];
            for (var l in h)
                t.hasOwnProperty(l) && !s || (t[l] = h[l])
        }
        return t
    }
    var n = {
...
Laro.register(".base", function() {
    ...
    function i(t, i, s) {
        for (var n in i)
            i.hasOwnProperty(n) && (t[n] = typeof i[n] === r && typeof s[h][n] === r && o.test(i[n]) ? e(n, i[n], s) : i[n])
    }
    function s(t, e) {
        function s() {}
        function n() {
            this.initialize ? this.initialize.apply(this, arguments) : (e || l && a.apply(this, arguments),
...
Laro.register(".game", function(t) {
    ...
    t = (t.Class || t.base.Class)(function(t, e, s) {
        void 0 != t && "object" == i(t) && (this.host = t,
        this.fsm = e,
        this.stateId = s,
        this.isSuspended = !1)
    }).methods({
...
Laro.register(".game", function(t) {
    var e = t.SimpleState || t.game.SimpleState
      , i = (t.Class || t.base.Class)(function(t, s, n) {
        ...
        update: function(t) {
            for (var e = 0; e < this.numSuspended; e++)
                this.stateArray[this.suspendedArray[e]].suspended(t);
            this.currentState != i.kNoState && (this.stateArray[this.currentState].update(t),
            this.currentState != i.kNoState && this.stateArray[this.currentState].transition())
        },
        message: function(t) {
        ...
        messageSuspended: function(t) {
            for (var e = 0; e < this.numSuspended; e++)
                this.stateArray[this.suspendedArray[e]].message(t)
        },
        tryChangeState: function(t, e, s, n, a) {
            return void 0 == n && (n = !0),
            void 0 == a && (a = !0),
            e == i.kNextState && (e = this.currentState + 1),
            !(!t || e == this.currentState && !n) && (this.setState(e, s, a),
            !0)
        },
        setState: function(t, e, s) {
            if (t == i.kNextState && (t = this.currentState + 1),
            t == i.kNoState) {
            ...
            else if (this.currentState != i.kNoState && this.stateArray[this.currentState].leave(),
            !this.stateArray[t].isSuspended)
                for (; this.numSuspended > 0; this.numSuspended--)
                    this.stateArray[this.suspendedArray[this.numSuspended - 1]].leave(),
                    this.stateArray[this.suspendedArray[this.numSuspended - 1]].isSuspended = !1;
            for (s = 0; s < this.numPreloaded; s++)
                this.preloadedArray[s] != t && this.stateArray[this.preloadedArray[s]].cancelPreload();
            this.numPreloaded = 0,
            void 0 != this.onStateChange && this.onStateChange(this.currentState, t, e),
            s = this.currentState,
            this.currentState = t,
            this.currentState != i.kNoState && (this.stateArray[this.currentState].isSuspended ? (this.stateArray[this.currentState].resume(e, s),
            this.stateArray[this.currentState].isSuspended = !1,
            --this.numSuspended) : this.stateArray[this.currentState].enter(e, s))
        },
    ...
    t = i.extend().methods({
        draw: function(t) {
            for (var e = 0; e < this.numSuspended; e++)
                this.stateArray[this.suspendedArray[e]].draw(t);
...
Class.extend = function(t) {
    ...
    initializing = !1;
    for (var n in t)
        s[n] = "function" == typeof t[n] && "function" == typeof i[n] && superTest.test(t[n]) ? function(t, e) {
            return function() {
                var s = this._super;
                this._super = i[t];
                var n = e.apply(this, arguments);
...
var extend = function(t, e, i) {
  ...
  , InteractiveClass = DisplayClass.extend({
    ...
    removeEventListener: function(t, e) {
        if (null !== this.eventListener[t] && void 0 !== this.eventListener[t]) {
            for (var i = 0; i < this.eventListener[t].length; i++)
                this.eventListener[t][i] == e && (delete this.eventListener[t][i],
                this.eventListener[t].splice(i, 1));
            0 === this.eventListener[t].length && delete this.eventListener[t]
        }
    },
    removeAllEventListener: function(t) {
        null !== this.eventListener[t] && void 0 !== this.eventListener[t] && (this.eventListener[t].splice(),
        delete this.eventListener[t])
    },
  ...
  , ObjectContainerClass = InteractiveClass.extend({
    ...
    removeChild: function(t) {
        if (this.children.splice(this.getChildIndex(t), 1),
        this.maxWidth == t.x + t.width) {
            this.maxWidth = 0;
            for (var e = 0; e < this.children.length; e++)
                this.maxWidth < this.children[e].x + this.children[e].width && (this.maxWidth = this.children[e].x + this.children[e].width)
        }
        if (this.maxHeight == t.y + t.height) {
            this.maxHeight = 0;
            for (var e = 0; e < this.children.length; e++)
                this.maxHeight < this.children[e].y + this.children[e].height && (this.maxHeight = this.children[e].y + this.children[e].height)
        }
        t.stage = null
    },
    removeChildAt: function(t) {
        ...
        if (this.maxWidth == e.x + e.width) {
            ...
            for (var i = 0; i < this.children.length; i++)
                this.maxWidth < this.children[i].x + this.children[i].width && (this.maxWidth = this.children[i].x + this.children[i].width)
        }
    ...
    dispatchMouseEvent: function(t, e, i) {
        function s(t) {
            var e = !1;
            switch (t.checkType || (t.checkType = "rect"),
            t.checkType) {
            case "rect":
        ...
        for (var n = e, a = i, r = [], o = this.children.length - 1; o >= 0; o--) {
            ...
            if (h.dispatchMouseEvent && h.dispatchMouseEvent(t, n - h.x, a - h.y),
            s(h)) {
                if ("mousemove" == t && r.length < 1 && r.push(h),
                null == h.eventListener[t] || void 0 == h.eventListener[t])
                    continue;
                for (var l = 0, c = h.eventListener[t]; l < c.length; l++)
                    c[l](n - h.x, a - h.y);
                break
            }
        }
        if ("mousemove" == t) {
            for (var d = 0; d < this.hoverChildren.length; d++) {
                for (var f = !1, u = 0; u < r.length; u++)
                    this.hoverChildren[d] == r[u] && (f = !0);
                if (!f) {
                    if (this.hoverChildren[d].eventListener.mouseout)
                        for (var o = 0, g = this.hoverChildren[d]; o < g.eventListener.mouseout.length; o++)
                            g.eventListener.mouseout[o](n - g.x, a - g.y);
                    delete this.hoverChildren[d];
                    break
                }
            }
            for (var d = 0; d < r.length; d++) {
                for (var f = !1, u = 0; u < this.hoverChildren.length; u++)
                    r[d] == this.hoverChildren[u] && (f = !0);
                if (!f && this.hoverChildren.length < 1) {
                    if (this.hoverChildren.push(r[d]),
                    r[d].eventListener.mouseover)
                        for (var o = 0, p = r[d]; o < p.eventListener.mouseover.length; o++)
                            p.eventListener.mouseover[o](n - p.x, a - p.y);
                    break
                }
            }
    ...
    clearHoverChildren: function() {
        for (var t = [], e = 0; e < this.hoverChildren.length; e++)
            null != this.hoverChildren[e] && void 0 != this.hoverChildren[e] && t.push(this.hoverChildren[e]);
  ...
  , Stage = ObjectContainerClass.extend({
    init: function(t, e) {
        ...
        function s(t) {
            t = t || r.canvas;
            for (var e = t.offsetWidth, i = t.offsetHeight, s = t.offsetTop, n = t.offsetLeft; t = t.offsetParent; )
                s += t.offsetTop,
                n += t.offsetLeft;
            return {
                top: s,
        ...
        if (this._super(t.getContext("2d"), e),
        void 0 === t)
        ...
        var n = window
          ...
          , o = function(t, e) {
            for (var n = 0; n < e.length; n++)
                t.addEventListener(e[n], function(t, n) {
                    return function(a) {
                        var r = s()
                          , o = i();
                        if (isTouchDevice) {
                            ...
                            var l = a.clientX - r.left + o.x
                              , c = a.clientY - r.top + o.y;
                        if (t.eventListener[e[n]])
                            for (var d = 0; d < t.eventListener[e[n]].length; d++)
                                t.eventListener[e[n]][d](l, c);
          ...
          , h = function(t, e) {
            for (var i = 0; i < e.length; i++)
                t.addEventListener(e[i], function(t, i) {
                    return function(s) {
                        if (t.eventListener[e[i]])
                            for (var n = 0; n < t.eventListener[e[i]].length; n++)
                                t.eventListener[e[i]][n](s)
                    }
                }(r, i), !1)
        };
  ...
  , ParticleBlock = Class.extend({
    init: function(t, e, i, s) {
        this.apply = function(n) {
            (n.position.x - n.size < t || n.position.x + n.size > i) && (n.velocity.x *= -1),
...
Laro.register("SOGOU.$func", function(t) {
    ...
    this.initWordsPos = function() {
        ...
        for (var e = document.querySelectorAll(".word"), i = document.querySelectorAll(".word_l"), s = 0; s < e.length; s++)
            e[s].style.fontSize = 55 * SOGOU.$func.scale + "px";
        for (var s = 0; s < i.length; s++)
            i[s].style.fontSize = 18 * SOGOU.$func.scale + "px";
        [].forEach.call(this.dlbtns, function(e, i) {
    ...
    this.tween = function(t, e, i, s, n, a) {
        if (1 != t.end) {
            ...
            r <= 0 && (r = 0),
            r <= i + ball_cache.end_t && r > 0 ? (void 0 != ball_cache.t_xpos && (t.xpos = ball_cache.f_xpos + (ball_cache.t_xpos - ball_cache.f_xpos) * s(r / (i + ball_cache.end_t))),
            void 0 != ball_cache.t_ypos && (t.ypos = ball_cache.f_ypos + (ball_cache.t_ypos - ball_cache.f_ypos) * s(r / (i + ball_cache.end_t))),
            void 0 != ball_cache.t_zpos && (t.zpos = ball_cache.f_zpos + (ball_cache.t_zpos - ball_cache.f_zpos) * s(r / (i + ball_cache.end_t))),
            void 0 != ball_cache.t_width && (t.width = ball_cache.f_width + (ball_cache.t_width - ball_cache.f_width) * s(r / (i + ball_cache.end_t)))) : (1 == n && r > i + ball_cache.end_t || n == -1 && r <= 0) && (t.end = !0)
        }
    }
    ,
    this.tween2 = function(t, e, i, s, n, a, r) {
        if (1 != t.end) {
            ...
            o <= 0 && (o = 0),
            o <= i + ball_cache.end_t && o > 0 ? (void 0 != ball_cache.t_xpos && (t.xpos = ball_cache.f_xpos + (ball_cache.t_xpos - ball_cache.f_xpos) * s(o / (i + ball_cache.end_t))),
            void 0 != ball_cache.t_ypos && (t.ypos = ball_cache.f_ypos + (ball_cache.t_ypos - ball_cache.f_ypos) * s(o / (i + ball_cache.end_t))),
            void 0 != ball_cache.t_zpos && (t.zpos = ball_cache.f_zpos + (ball_cache.t_zpos - ball_cache.f_zpos) * s(o / (i + ball_cache.end_t))),
            void 0 != ball_cache.t_width && void 0 != ball_cache.f_width && (t.width = Math.max(0, ball_cache.f_width + (ball_cache.t_width - ball_cache.f_width) * s(o / (i + ball_cache.end_t))))) : 1 == n && o > i + ball_cache.end_t ? (void 0 != ball_cache.t_xpos && (t.xpos = ball_cache.t_xpos),
            void 0 != t.t_ypos && (t.ypos = ball_cache.t_ypos),
            void 0 != t.t_zpos && (t.zpos = ball_cache.t_zpos),
            void 0 != t.t_width && void 0 != t.f_width && (t.width = ball_cache.t_width),
            t.end = !0) : n == -1 && o <= 0 && (void 0 != ball_cache.f_xpos && (t.xpos = ball_cache.f_xpos),
            void 0 != t.f_ypos && (t.ypos = ball_cache.f_ypos),
            void 0 != t.f_zpos && (t.zpos = ball_cache.f_zpos),
            void 0 != t.t_width && void 0 != t.f_width && (t.width = ball_cache.f_width),
            t.end = !0)
        }
    }
    ,
    ...
    this.initEvents = function() {
        ...
        var t = document.querySelectorAll(".dlbtn");
        ...
        var e = document.querySelectorAll(".links li");
        ...
        return l._resize = function(t) {
            ...
            case 0:
                ...
                if (s > 0 && n >= 0)
                    ...
                    var h = 2 * Math.PI + Math.atan(n / s);
                else if (s < 0)
                    var h = Math.PI + Math.atan(n / s);
                else if (0 == s && n > 0)
                    var h = .5 * Math.PI;
                else if (0 == s && n < 0)
                    var h = 1.5 * Math.PI;
    ...
    this.getParticles = function(t, e, i) {
        ...
        for (var s, n = [], a = 0; a < t.length; a++) {
            var r = t[a][2]
              ...
              , o = !1;
            if ("icons" === i) {
                (t[a][1] < 475 || t[a][1] > 1430 || t[a][0] < 434 || t[a][0] > 580) && (s = "rgba(255,255,255," + range(.2, .6) + ")",
                o = !0);
        ...
        for (var s = 0; s < this.logoParticles.length; s++) {
            ...
            if (!(t < n.start_t)) {
                ...
                var a = n.r1
                  ...
                  , l = n.t_xpos
                  , c = n.t_ypos;
                n.t > e ? (n.xpos = n.t_xpos + 161 * this.scale,
                n.ypos = n.t_ypos,
                pos = n.getScreenXY(),
                n.x = pos.x,
                n.y = pos.y) : (n.r = r,
                n.xpos = r * Math.cos(h) + l + 161 * this.scale,
                n.ypos = r * Math.sin(h) + c,
                pos = n.getScreenXY(),
                n.x = pos.x,
                n.y = pos.y)
            }
...
Laro.register("SOGOU.$func", function(t) {
    ...
    this.vibrate = function(t, e) {
        void 0 != t.step && 0 != t.step || (t.step = 0,
        t.direction = 1,
        t.theta = randomTheta(),
        t.d = range(5, 20),
        t.dx = 0,
        t.dy = 0),
        t.direction > 0 ? (t.step++,
        t.dx += 1.2 * Math.cos(t.theta) / 6,
        t.dy += 1.2 * Math.sin(t.theta) / 6) : (t.step--,
        t.dx -= 1.2 * Math.cos(t.theta) / 6,
        t.dy -= 1.2 * Math.sin(t.theta) / 6),
        t.step >= t.d ? t.direction = -1 : t.step <= 0 && (t.dx = t.dy = 0,
        t.direction = 1)
    }
}),
Laro.register("SOGOU.$func", function(t) {
    this.resetBalls = function() {
        for (var t = 0; t < this.logoParticles.length; t++)
            ball = this.logoParticles[t],
            ball.step = 0,
            ball.step0 = {},
    ...
    this.forwardAndBack = function(t, e, i) {
        ...
        t.xpos += 1.2) : (t.step--,
        t.xpos -= 1.2),
        t.step >= t.d ? (t.step = t.d,
        t.direction = -1) : t.step <= 0 && (t.step = 0,
        t.direction = 1)
    }
    ,
...
Laro.register("SOGOU.$func", function(t) {
    ...
    this.vibratePart2 = function(t, e, i) {
        ...
        t.direction > 0 ? (t.step++,
        t.dx += i * Math.cos(t.theta) / 6,
        t.xpos = t.bi_x + t.dx,
        t.dy += i * Math.sin(t.theta) / 6,
        t.ypos = t.bi_y + t.dy) : (t.step--,
        t.dx -= i * Math.cos(t.theta) / 6,
        t.xpos = t.bi_x + t.dx,
        t.dy -= i * Math.sin(t.theta) / 6,
        t.ypos = t.bi_y + t.dy),
...
Laro.register("SOGOU.$func", function(t) {
    this.initDnaList = function(t) {
        ...
        for (var e = arr3, i = 20, s = 0; s < e.length; s++) {
            var n, a, r = e[s][2], o = i * r * this.scale, a = 59, h = 117;
            n = s <= 4 ? .5 : 0;
    ...
    this.dnaRotate = function(t, e, i, s, n, a) {
        for (var r = 0; r < 7; r++) {
            ...
            if (!(o.stop_t && t >= o.stop_t)) {
                o.stop || (this.roll(o, t, i, 0),
                this.scalew(o, t, n, 1)),
                h.stop || (this.roll(h, t, -i, 0),
                this.scalew(h, t, n, -1));
                var l = o.getScreenXY();
                o.x = l.x,
                o.y = l.y;
...
Laro.register("SOGOU.$states", function(t) {
    ...
    this.logo = t.BaseState.extend(function() {}).methods({
        enter: function() {
            if (sogou.manager.lock(),
            "previous" == sogou.manager.from)
                this._t = e;
            else {
...
Laro.register("SOGOU.$states", function(t) {
    this.breathe = t.BaseState.extend(function() {}).methods({
        enter: function() {
            ...
            for (var t = 0; t < SOGOU.$func.logoParticles.length; t++)
                ball = SOGOU.$func.logoParticles[t],
...
Laro.register("SOGOU.$states", function(t) {
    this.expand = t.BaseState.extend(function() {}).methods({
        enter: function(t, e) {
            ...
            "next" == SOGOU.manager.from && e <= this.state - 1 ? (this._t = 0,
            this.step = 0,
            i.initParticlesLogo(),
            i.resetBalls(),
            i.resetBallStartTime(i.logoParticles),
            this.direction = 1,
            SOGOU.$func.w2.classList.remove("slideright_back"),
            SOGOU.$func.w2.clientWidth,
            SOGOU.$func.w2.classList.add("slideright")) : "reverse" == SOGOU.manager.from && e == this.state ? (this._t = 1.5,
            this.direction = -1,
            i.initParticlesLogo(),
            SOGOU.$func.w2.classList.remove("slideright"),
            SOGOU.$func.w2.clientWidth,
            SOGOU.$func.w2.classList.add("slideright_back"),
            SOGOU.$func.resizeInstance()) : "previous" == SOGOU.manager.from && e == this.state + 1 && (this.direction = 1,
            this._t = 1.5,
            SOGOU.$func.w2.classList.remove("slideright_back"),
            SOGOU.$func.w2.clientWidth,
            ...
            for (var s = 0; s < SOGOU.$func.logoParticles.length; s++)
                ball = SOGOU.$func.logoParticles[s],
                SOGOU.$func.stage.addChild(ball)
        },
        leave: function() {
            for (var t = 0; t < SOGOU.$func.logoParticles.length; t++)
                ...
                SOGOU.$func.stage.removeChild(ball);
            if (this.f.line_arr) {
                for (var t = 0; t < this.f.line_arr.length; t++)
                    this.f.stage.removeChild(this.f.line_arr[t]);
        ...
        transition: function() {
            1 == this.direction ? this._t > 1.5 && (sogou.manager.unlock(),
            this._t > 6 && sogou.manager.auto && sogou.manager.next()) : this._t < -2 * this.dt && sogou.manager.previous()
        },
        draw: function() {
            for (var t = 0; t < this.f.logoParticles.length; t++) {
                var e = this.f.logoParticles[t];
                1 == e.end && (this.f.resetEnd(e),
                "next" == SOGOU.manager.from ? e.step = e.step + 1 <= 1 ? e.step - 1 : 1 : e.step = e.step - 1 >= 0 ? e.step - 1 : 0),
            ...
            if (this._t <= this.anim.ball_line[0].to_time && (this.f.ball_line.xpos = this.f.ball_head.xpos + this.f.canvas.width / 2 - this.f.ball_line.width,
            i = this.f.ball_line.getScreenXY(),
            this.f.ball_line.x = i.x,
            this.f.ball_line.y = i.y),
            this._t > this.anim.ball_line[1].from_time) {
                ...
                var i = this.f.ball_head.getScreenXY();
                if (this.f.ball_head.x = i.x,
                this.f.ball_head.y = i.y,
                this.f.ball_line.xpos = this.f.ball_head.xpos + this.f.canvas.width / 2 - this.f.ball_line.width,
                i = this.f.ball_line.getScreenXY(),
                this.f.ball_line.x = i.x,
                this.f.ball_line.y = i.y,
                this.f.line_arr)
                    for (var t = 0; t < this.f.line_arr.length; t++)
                        this.f.line_arr[t].end && (this.f.line_arr[t].end = !1,
                        this.f.line_arr[t].start_t = this._t),
    ...
    this.roll = t.BaseState.extend(function() {}).methods({
        enter: function(t, e) {
            ...
            var s = this.ball_head_box = document.getElementById("ball_head_box")
              , n = (this.ball_head = document.getElementById("ball_head"),
            ...
            if ("next" == SOGOU.manager.from) {
                ...
                if (i.iconsParticles)
                    for (var l = 0; l < i.iconsParticles.length; l++) {
        ...
        update: function(t) {
            ...
            this._t >= this.anim.iconball[0].from_time)
        ...
        transition: function() {
            1 == this.direction ? this._t > 2 && sogou.manager.next(!0) : this._t <= -this.dt && (this.ball_head_box.style.display = "none",
            sogou.manager.previous())
        },
        draw: function() {
            if (this._t >= this.anim.iconball[0].from_time)
            ...
            1 == this.direction && (this._t > this.anim.words[0].from_time ? (this.ball_head_box.style.display = "none",
            this.f.w3.classList.remove("fadeout"),
            this.f.w3.clientWidth,
            this.f.w3.classList.add("fadein")) : this.ball_head_box.style.display = "block")
        }
    })
}),
Laro.register("SOGOU.$states", function(t) {
    this.vibrate = t.BaseState.extend(function() {}).methods({
        enter: function(t, e) {
            ...
            this.T = 1,
            this.state = 4,
            "next" == SOGOU.manager.from)
                this.direction = 1;
            else {
                if ("reverse" == SOGOU.manager.from && e == this.state)
    ...
    this.disperse = t.BaseState.extend(function() {}).methods({
        enter: function(t, e) {
            ...
            "next" == SOGOU.manager.from && e <= this.state - 1) {
                ...
                this._t = 0,
                i.iconsParticles)
                    for (var s = 0; s < i.iconsParticles.length; s++) {
                ...
                i.initDnaBalls(),
                setTimeout(function() {
                    for (var t = 0; t < i.dnaBalls.length; t++)
                        i.stage.addChild(i.dnaBalls[t]);
                    for (var t = 0; t < i.dnaBgBalls.length; t++)
                        i.stage.addChild(i.dnaBgBalls[t])
                }, 600)
                ...
                SOGOU.$func.resizeInstance(),
                this.f.dnaBalls)
                    for (var s = 0; s < this.f.dnaBalls.length; s++)
                        this.f.stage.addChild(this.f.dnaBalls[s]);
                for (var s = 0; s < this.f.dnaBgBalls.length; s++)
                    this.f.stage.addChild(this.f.dnaBgBalls[s])
        ...
        leave: function() {
            if (this.f.dnaBalls)
                for (var t = 0; t < this.f.dnaBalls.length; t++)
                    this.f.stage.removeChild(this.f.dnaBalls[t]);
            if (SOGOU.$func.dnaBgBalls)
                for (var t = 0; t < SOGOU.$func.dnaBgBalls.length; t++) {
                    var e = SOGOU.$func.dnaBgBalls[t];
        ...
        update: function(t) {
            if (1 == this.direction ? this._t += t : this._t -= 2 * t,
            this.f.iconsParticles)
                for (var e = 0; e < this.f.iconsParticles.length; e++) {
                    var i = this.f.iconsParticles[e]
                      , s = i.getScale();
        ...
        transition: function() {
            this.direction == -1 && this._t < 1 && (SOGOU.$func.w3.classList.remove("fadeout"),
            SOGOU.$func.w3.clientWidth,
            SOGOU.$func.w3.classList.add("fadein"))
        },
        draw: function() {
            if (this._t < this.anim.dnaBalls[0].from_time)
                for (var t = 0; t < this.f.dnaBalls.length; t++) {
            ...
            if (this._t < this.anim.dnaBgBalls[0].from_time)
                for (var t = 0; t < this.f.dnaBgBalls.length; t++) {
...
Laro.register("SOGOU.$states", function(t) {
    this.dna = t.BaseState.extend(function() {}).methods({
        enter: function(t, e) {
            if (sogou.manager.lock(),
            this.init_t = Math.PI + .06,
            this.last_t = t,
            document.body.style.perspective = "none",
            this.anim = [],
            this.anim.dnaConnectLine = [{
                from_time: 0,
                to_time: .15
            }],
            this.anim.dnaRotate = [{
            ...
            this.fromState = e,
            "next" == SOGOU.manager.from)
                e == this.state ? this._t = .15 : this._t = 0,
                this.direction = 1,
                SOGOU.$func.initDnaList(this.init_t),
                e <= this.state - 1 && (SOGOU.$func.w4.classList.remove("rotateout"),
                SOGOU.$func.w4.clientWidth,
                ...
                for (var i = 0; i < SOGOU.$func.dnaList.length; i++)
                    for (var s = SOGOU.$func.dnaList[i], n = 0; n < 7; n++) {
                        var a = s[n].ball_left
                          , r = s[n].ball_right;
        ...
        leave: function() {
            ...
            1 == this.direction && (SOGOU.$func.w4.classList.add("rotateout"),
        ...
        transition: function() {
            ...
            this.dnastop || this._t < -this.dt && this.direction == -1 && (this.dnastop = !0,
            sogou.manager.previous())
        },
        draw: function() {
            this._t;
            ...
            this._t >= this.anim.dnaRotate[0].from_time ? (start_t = this._t + this.init_t - this.anim.dnaRotate[0].from_time,
            SOGOU.manager.globalT = this.stop_t = start_t,
            SOGOU.$func.dnaList.forEach(function(t, e) {
            ...
            })) : this.from_next && (SOGOU.manager.from = "next",
            sogou.$fsm.setState(this.state))
        }
    })
}),
Laro.register("SOGOU.$states", function(t) {
    this.dnaleave = t.BaseState.extend(function() {}).methods({
        enter: function(t, e) {
            ...
            this.state = 7,
            this.T = .5,
            "next" == SOGOU.manager.from && e <= this.state - 1 ? (this.direction = 1,
            this.last_t = t,
            this._t = 0,
            SOGOU.$func.initMainDna(),
            SOGOU.$func.resetDnaBallsOther()) : "reverse" == SOGOU.manager.from && e == this.state ? (this.direction = -1,
            this.last_t = t - this.T,
            this._t = this.T,
            SOGOU.$func.resizeInstance()) : "previous" == SOGOU.manager.from && e == this.state + 1 && (this.direction = -1,
            this.last_t = t - this.T,
            this._t = this.T,
            SOGOU.$func.resizeInstance(),
            SOGOU.$func.w4.classList.remove("rotateout"),
            SOGOU.$func.w4.clientWidth,
            SOGOU.$func.w4.classList.add("rotatein")),
            this.flag = !0,
            SOGOU.$func.resetDnaBgBalls2(),
            SOGOU.$func.dnaBgBalls)
                for (var i = 0; i < SOGOU.$func.dnaBgBalls.length; i++) {
                    var s = SOGOU.$func.dnaBgBalls[i];
                    SOGOU.$func.stage.addChild(s)
                }
            for (var i = 0; i < SOGOU.$func.dnaList.length; i++)
                for (var n = SOGOU.$func.dnaList[i], a = 0; a < 7; a++) {
                    var r = n[a].ball_left
                      , o = n[a].ball_right;
                    SOGOU.$func.stage.addChild(r),
                    SOGOU.$func.stage.addChild(o)
        ...
        leave: function() {
            if (document.body.style.perspective = "700px",
            SOGOU.$func.dnaBgBalls)
                for (var t = 0; t < SOGOU.$func.dnaBgBalls.length; t++) {
                    var e = SOGOU.$func.dnaBgBalls[t];
                    SOGOU.$func.stage.removeChild(e)
            ...
            for (var t = 0; t < SOGOU.$func.dnaList.length; t++)
                for (var i = SOGOU.$func.dnaList[t], s = 0; s < 7; s++) {
                    var n = i[s].ball_left
                      , a = i[s].ball_right;
                    SOGOU.$func.stage.removeChild(n),
                    SOGOU.$func.stage.removeChild(a)
        ...
        draw: function() {
            for (var t = this._t, e = SOGOU.$func.dnaMainBalls, i = 0; i < e.length; i += 2) {
                ...
                if (n.x = a.x,
                n.y = a.y,
                1 == s.end && this.direction == -1 && ("next" == SOGOU.manager.from ? s.step = s.step + 1 <= 1 ? s.step - 1 : 1 : s.step = s.step - 1 >= 0 ? s.step - 1 : 0),
                0 == s.step) {
                    var r = (e[i].xpos + e[i + 1].xpos) / 2;
                    n.bi_x = s.bi_x = r
                } else if (i >= e.length - 2 && (this.stop_t = this.last_t + this._t,
                this.flag)) {
                    this.flag = !1;
            ...
            for (var i = 0; i < e.length; i += 2)
                var s = e[i]
                  , n = e[i + 1];
            for (var l = SOGOU.$func.dnaBallOthers, i = 0; i < l.length; i++) {
                var h = l[i];
    ...
    this.dna2circle = t.BaseState.extend(function() {}).methods({
        enter: function(t, e) {
            ...
            "next" == SOGOU.manager.from && e <= this.state - 1) {
                ...
                "reverse" == SOGOU.manager.from && e == this.state ? (this.direction = -1,
                this._t = t,
                this.step = 2,
                SOGOU.$func.resizeInstance()) : "previous" == SOGOU.manager.from && e == this.state + 1 && (this.direction = -1,
                SOGOU.$func.resizeInstance())
        ...
        leave: function() {
            if (this.direction == -1)
                for (var t = 0; t < SOGOU.$func.dna_main.length; t++) {
        ...
        draw: function() {
            var t = this._t
              , e = SOGOU.$func.ctx;
            if (0 == this.step && (SOGOU.$func.dnaRotate(this.last_t + this._t, SOGOU.$func.dna_main, 117 * SOGOU.$func.dna_main.scale * SOGOU.$func.scale, 5 * SOGOU.$func.dna_main.scale * SOGOU.$func.scale, 5 * SOGOU.$func.dna_main.scale * SOGOU.$func.scale, SOGOU.$func.dna_main.color),
            SOGOU.$func.dnaList.forEach(function(t) {
                SOGOU.$func.connectDna(t, 5 * t.scale * SOGOU.$func.scale, t.color)
            }),
            1 == this.direction))
                for (var i = 0; i < SOGOU.$func.dna_main.length; i++)
                    if (ball_left = SOGOU.$func.dna_main[i].ball_left,
                    ball_right = SOGOU.$func.dna_main[i].ball_right,
                    Math.abs(parseInt(ball_left.xpos)) <= Math.ceil(6 / SOGOU.$func.scale) && this.stop_index == i) {
                        ball_left.xpos = 0,
                        ball_right.xpos = 0;
...
Laro.register("SOGOU.$states", function(t) {
    this.rotatelogo = t.BaseState.extend(function() {}).methods({
        enter: function(t, e) {
            ...
            if (SOGOU.manager.globalT = this.last_t = t,
            SOGOU.$func.circles = [{
                color: "#fff",
                radius: i,
                angle: Math.PI / 2
        ...
        draw: function() {
            ...
            var t = 1e3 * this._t
              ...
              , n = this.speed;
            Math.PI2 = 2 * Math.PI;
            var a = (SOGOU.$func.loxo,
            SOGOU.$func.rotateX)
              , r = SOGOU.$func.rotateY
              , o = SOGOU.$func.rotateZ;
            if (this.angleOffset += .1 * (this.angleOffsetGoal - this.angleOffset),
            this.direction == -1 && !this.stop) {
                this.stop = !0;
                var h = this;
            ...
            if (.001 * t * n < Math.PI && t > 0)
                var t = .001 * t * n % Math.PI;
            if (1 == this.direction && this.stop || this.direction == -1 && !this.stop_back)
                return void SOGOU.$func.ctx.translate(.5 * -SOGOU.$func.canvas.width, .5 * -SOGOU.$func.canvas.height);
            if (t >= Math.PI)
                var t = Math.PI;
            else if (t <= 0)
                var t = 0;
            if (this.direction == -1 && 0 == t)
                return SOGOU.$func.ctx.translate(.5 * -SOGOU.$func.canvas.width, .5 * -SOGOU.$func.canvas.height),
            ...
            var l, c, d, f, u = -t - .5 * Math.PI, g = .5 * Math.PI * Math.cos(t), p = SOGOU.$func.twistEasing(.5 * (Math.cos(2 * t + Math.PI) + 1)), _ = 2 * p * Math.PI2, v = 2 * t > Math.PI ? 1 : -1, m = [];
            for (l = 0,
            c = i.length; l < c; l++) {
                var O = SOGOU.$func.loxo(i[l].radius, _, s);
                for ((!this.x || this.x < 10) && (this.x = this.x ? ++this.x : 1),
                d = 0,
                f = s; d < f; d++)
                    O[d] = a(O[d], i[l].angle * (1 - p) * v),
                    O[d] = r(o(r(O[d], u), g), Math.PI / 2);
                m.push(O)
            }
            for (l = i.length - 1; l >= 0; l--) {
                for (e.strokeStyle = i[l].color,
                e.beginPath(),
                d = 0,
                f = s; d < f; d++) {
                    var S = m[l][d];
...
sogou.manager = {
    ...
    next: function(t, e, i) {
        this.max != this.index && (this.locked && !t || (this.locked = !0,
        this.from = "next",
        sogou.$fsm.setState(++this.index, e),
        2 != this.index && 3 != this.index && 5 != this.index && 7 != this.index || (this.page++,
        i && i())))
    },
    ...
    reverse: function(t, e, i) {
        1 != this.index && (this.locked || (this.locked = !0,
        this.from = "reverse",
        sogou.$fsm.setState(this.index, e),
        this.page--,
        i && i()))
...
document.querySelector(".down").addEventListener("click", function(t) {
    sogou.manager.auto = !1;
